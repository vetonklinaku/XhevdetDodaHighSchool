            ...
            <div className="col-lg-5 col-md-5 col-sm-12">
                ...
                <div id="demo" className="carousel slide" data-ride="carousel">
                    ...
                    <div className="carousel-inner">
                        ...
                        <div className="carousel-item">
                            <img src={p6} className={style.foto} alt=''/>
                        </div>

                        <div className="carousel-item">
                            <img src={p7} className={style.foto} alt=''/>
                        </div>

                        <div className="carousel-item">
                            <img src={p8} className={style.foto}alt=''/>
                        </div>

                        <div className="carousel-item">
                            <img src={p9} className={style.foto}alt=''/>
                        </div>

                        <div className="carousel-item">
                            <img src={p10} className={style.foto}alt=''/>
                        </div>

                        <div className="carousel-item">
                            <img src={p11} className={style.foto}alt=''/>
                        </div>

                        <div className="carousel-item">
                            <img src={p12} className={style.foto}alt=''/>
                        </div>

                        <div className="carousel-item">
                            <img src={p13} className={style.foto}alt=''/>
                        </div>
                    </div>
